...
class CommitTransformer {
    companion object {
        ...
        fun addToProject(commitDTO: CommitDTO, project: Project, changeFactory: ChangeFactory = SimpleChangeFactory()) {
        ...
        private fun addChangesToCommit(changes: List<ChangeDTO>, commit: Commit, project: Project, changeFactory: ChangeFactory) {
