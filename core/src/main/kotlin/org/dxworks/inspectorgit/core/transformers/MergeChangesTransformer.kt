...
class MergeChangesTransformer {
    ...
    companion object {
        ...
        fun transform(changeDTOs: List<ChangeDTO>, commit: Commit, project: Project, changeFactory: ChangeFactory): List<Change> {
        ...
        private fun fixChanges(changes: List<Change>, commit: Commit, project: Project): List<Change> {
        ...
        private fun mergeFiles(changes: List<Change>, missingChange: Change?, project: Project) {
