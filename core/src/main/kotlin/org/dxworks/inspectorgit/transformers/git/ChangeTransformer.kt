...
class ChangeTransformer(private val changeDTO: ChangeDTO, private val commit: Commit, private val project: GitProject, private val changeFactory: ChangeFactory) {
    companion object {
    ...
    fun transform(): Change? {
        ...
        val file = getFileForChange(changeDTO, lastChange)
    ...
    private fun getFileForChange(change: ChangeDTO, lastChange: Change?): File {
